    ...
    <MainTemplate>
      <Container>
        <GenericHtml>
          ...
          <p>
            All your completed tasks and cycles are saved in the <a href='/history'>history</a>, marked as completed or
          ...
          <p>
            <strong>Ready to focus?</strong> Let’s go back to the <a href='/'>home page</a> and start your Pomodoros!
            🍅🚀
          </p>
          <p>
